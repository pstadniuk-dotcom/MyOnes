...
// Conversation Insights - AI analysis of user conversations
export const conversationInsights = pgTable("conversation_insights", {
  ...
  // Structured insights
  ingredientRequests: json("ingredient_requests").notNull(),
  featureRequests: json("feature_requests").notNull(),
  commonQuestions: json("common_questions").notNull(),

  // Sentiment breakdown
  sentimentOverview: json("sentiment_overview").notNull(), // { positive: 60, neutral: 30, negative: 10 }

  // Additional insights
  topThemes: json("top_themes"), // Array of strings
  actionableInsights: json("actionable_insights"), // Array of strings

  // Raw full analysis for debugging/reference
