 ...
 * tests cover:
 *   1. Heuristic gate (shouldRunAIExtractor) ΓÇö when should we burn an AI call?
 *   2. Response parsing ΓÇö strict catalog validation, JSON extraction.
...
describe('shouldRunAIExtractor ΓÇö heuristic gate', () => {
