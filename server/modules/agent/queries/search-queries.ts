...
export const PODCAST_QUERIES: string[] = [
  ...
  'health supplement podcast "be a guest" OR "guest application" OR "guest form" 2024 2025',
...
export const PRESS_QUERIES: string[] = [
  ...
  '"write for us" personalized nutrition OR supplements OR health tech blog 2024 2025',
  ...
  // Product reviews
  'supplement review blog OR magazine "submit product" OR "product review request" personalized 2024 2025',
  'health wellness product review "send us" OR "review request" supplement brand',

  // Founder features
  'health startup founder feature OR profile supplement company wellness brand 2024 2025',
  ...
  // Magazine editorial
  'health wellness magazine editorial calendar 2025 supplements nutrition feature',
];
