...
const DEFAULT_PROFILE: FounderProfile = {
  ...
  bioShort:
    'Pete is the founder of Ones. People either buy 10 different supplement bottles hoping they get it right, overdosing, underdosing, lower quality ingredients, or they go the AG1/multivitamin route which is completely generic. Ones uses AI to analyze your blood work, health data, and wearable metrics to design one custom formula from over 150 ingredients at research-backed doses, and it adapts as your health changes.',

  bioMedium:
    'Pete is the founder and CEO of Ones. Right now people are stuck between two bad options: buying a stack of 10+ supplement bottles, guessing at what they need, often getting lower quality ingredients, overdosing on some things and underdosing on others. Or going the AG1/daily multivitamin route, which is convenient but completely generic with zero customization. Ones solves both problems. Our AI analyzes your blood work, health data, and wearable metrics to design one custom formula from over 150 ingredients at research-backed doses, built for your body and adapting as your health data changes.',
...
So he built Ones to solve both. The platform uses AI to analyze your individual blood work, health data, and wearable metrics from devices like Oura, Whoop, and Fitbit. The AI selects from over 150 ingredients at research-backed doses and designs one custom formula built specifically for your body. No more guessing with a stack of bottles, no more settling for a generic blend.

And the formula isn't static. As new health data comes in, updated labs, changing biometrics, the AI adapts your formula so it evolves with you.`,
  ...
  talkingPoints: [
    ...
    'Ones solves both: our AI analyzes your blood work, health data, and wearable metrics to design one custom formula from over 150 ingredients at research-backed doses',
    'Your formula isn\'t static. The AI adapts it as your health data changes, so it actually evolves with you',
  ...
  uniqueAngles: [
    ...
    'Data angle: your formula isn\'t a one-time thing. The AI adapts it as your blood work, wearable data, and health goals change',
  ...
  credentials: [
    ...
    'Built AI that analyzes health data to design custom formulas from 150+ supplement ingredients',
