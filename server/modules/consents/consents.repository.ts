...
export class ConsentsRepository {
    ...
    async getUserConsent(userId: string, consentType: 'lab_data_processing' | 'ai_analysis' | 'data_retention' | 'third_party_sharing' | 'sms_accountability'): Promise<UserConsent | undefined> {
    ...
    async revokeUserConsent(userId: string, consentType: 'lab_data_processing' | 'ai_analysis' | 'data_retention' | 'third_party_sharing' | 'sms_accountability'): Promise<boolean> {
