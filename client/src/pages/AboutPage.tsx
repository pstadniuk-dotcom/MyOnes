      ...
      <section className="relative pt-32 pb-24">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-[#054700] mb-6 leading-tight" data-testid="heading-about-hero">
              Transforming Health,<br />One Formula at a Time
            </h1>
            <p className="text-xl text-[#5a6623] max-w-2xl mx-auto" data-testid="text-about-description">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-light text-[#054700] mb-6" data-testid="heading-mission">
                Our Mission
              </h2>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="glass-card rounded-2xl p-6 shadow-sm">
                <Target className="w-8 h-8 text-[#054700] mb-4" />
                <h3 className="font-medium text-[#054700] mb-2">Personalized</h3>
                <p className="text-sm text-[#5a6623]">Custom formulas based on your unique health profile</p>
              </div>
              <div className="glass-card rounded-2xl p-6 shadow-sm">
              ...
              <div className="glass-card rounded-2xl p-6 shadow-sm">
                ...
                <h3 className="font-medium text-[#054700] mb-2">Expert-Guided</h3>
                <p className="text-sm text-[#5a6623]">AI trained on medical-grade health assessments</p>
              </div>
              <div className="glass-card rounded-2xl p-6 shadow-sm">
                <Heart className="w-8 h-8 text-[#054700] mb-4" />
                <h3 className="font-medium text-[#054700] mb-2">Simple</h3>
                <p className="text-sm text-[#5a6623]">One capsule, all your nutrients, delivered monthly</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-[#054700] mb-8 text-center" data-testid="heading-story">
              Our Story
            </h2>
