  ...
  return (
    <div className="min-h-screen bg-[#ede8e2]">
      ...
      <div className="container mx-auto px-6 pt-32 pb-24 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-light text-[#054700] mb-6 text-center" data-testid="heading-refunds">
          Refund Policy
        </h1>
        ...
        <div className="glass-card rounded-2xl p-8 md:p-12 shadow-sm space-y-8">
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Custom-Made Products</h2>
            ...
            <p className="text-[#5a6623]">
              Due to the personalized and custom-made nature of our products, <strong className="text-[#054700]">we do not offer refunds, returns, or cancellations</strong> on any orders once they have been placed and manufactured.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Why No Refunds?</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Order Carefully</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Shipping Errors</h2>
            <p className="text-[#5a6623] mb-4">
