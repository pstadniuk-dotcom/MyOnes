...
function CurrentFormulaWidget({ formula }: { formula: Formula }) {
  ...
  const safetyPercentage = Math.min((formula.totalMg / 5500) * 100, 100);
  const isOptimal = formula.totalMg >= 4500 && formula.totalMg <= 5500;
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span>Capsule Fill (4500-5500mg)</span>
              <span className="font-medium">{formula.totalMg}mg / 5500mg</span>
            </div>
            <Progress 
