  ...
  return (
    <div className="min-h-screen bg-[#ede8e2]">
      ...
      <div className="container mx-auto px-6 pt-32 pb-24 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-light text-[#054700] mb-6 text-center" data-testid="heading-returns">
          Returns Policy
        </h1>
        <p className="text-sm text-[#5a6623] mb-12 text-center">Last updated: November 2025</p>

        <div className="glass-card rounded-2xl p-8 md:p-12 shadow-sm space-y-8">
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">No Returns on Custom Orders</h2>
            ...
            <p className="text-[#5a6623]">
              Due to the personalized and made-to-order nature of our products, <strong className="text-[#054700]">we do not accept returns or exchanges</strong> on any orders. Once your custom formula is manufactured, it cannot be resold or used by another customer.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Why Custom Products Cannot Be Returned</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Review Your Order Carefully</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Damaged or Defective Products</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Shipping Address Errors</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Formula Adjustments</h2>
            <p className="text-[#5a6623] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-light text-[#054700] mb-4">Questions Before Ordering?</h2>
            <p className="text-[#5a6623] mb-4">
