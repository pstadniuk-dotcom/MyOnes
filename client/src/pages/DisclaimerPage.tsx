  ...
  return (
    <div className="min-h-screen bg-[#ede8e2]">
      ...
      <div className="container mx-auto px-6 pt-32 pb-24 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-light text-[#054700] mb-4" data-testid="heading-disclaimer">
          Medical Disclaimer
        </h1>
        <p className="text-sm text-[#5a6623] mb-12">Last updated: March 2024</p>
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Not Medical Advice</h2>
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Consult Your Healthcare Provider</h2>
            <p className="text-[#5a6623] mb-4 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">FDA Disclaimer</h2>
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Not HIPAA Compliant</h2>
            <p className="text-[#5a6623] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Individual Results May Vary</h2>
            <p className="text-[#5a6623] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Allergies and Sensitivities</h2>
            <p className="text-[#5a6623] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Pregnancy and Nursing</h2>
            <p className="text-[#5a6623] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Medical Emergencies</h2>
            <p className="text-[#5a6623] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Accuracy of Information</h2>
            <p className="text-[#5a6623] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-medium text-[#054700] mb-4">Questions or Concerns</h2>
            <p className="text-[#5a6623] leading-relaxed">
              If you have questions about our products, recommendations, or this medical disclaimer, please contact us at <a href="mailto:support@ones.health" className="text-[#054700] underline underline-offset-2 hover:text-[#054700]/80">support@ones.health</a> or consult with your healthcare provider.
            </p>
          </section>
        </div>
      </div>
