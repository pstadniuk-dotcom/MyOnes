...
export default function PartnershipsPage() {
  return (
    <div className="min-h-screen bg-[#ede8e2]">
      ...
      <section className="pt-32 pb-24">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-[#054700] mb-6">
              Partnerships
            </h1>
            <p className="text-xl text-[#5a6623] max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#ede8e2] rounded-2xl p-8 md:p-10">
              <div className="w-12 h-12 bg-[#054700]/10 rounded-xl flex items-center justify-center mb-6">
              ...
              <ul className="space-y-3 text-[#5a6623]">
                <li className="flex items-start gap-3">
                  <TrendingUp className="w-5 h-5 text-[#054700] mt-0.5 flex-shrink-0" />
                  <span>Competitive commission structure</span>
                </li>
                <li className="flex items-start gap-3">
                  <Users className="w-5 h-5 text-[#054700] mt-0.5 flex-shrink-0" />
                  <span>Dedicated partnership manager</span>
                </li>
                <li className="flex items-start gap-3">
                  <Heart className="w-5 h-5 text-[#054700] mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-[#ede8e2] rounded-2xl p-8 md:p-10">
              <div className="w-12 h-12 bg-[#054700]/10 rounded-xl flex items-center justify-center mb-6">
                <Users className="w-6 h-6 text-[#054700]" />
              </div>
              <h2 className="text-2xl font-light text-[#054700] mb-4">General Partnerships</h2>
              <p className="text-[#5a6623] mb-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm">
                <span className="text-2xl font-light text-[#054700]">AI</span>
              </div>
              <h3 className="font-medium text-[#054700] mb-2">Cutting-Edge Technology</h3>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm">
                <span className="text-2xl font-light text-[#054700]">✓</span>
              </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-[#054700] mb-2">Customer Success</h3>
              <p className="text-sm text-[#5a6623]">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-[#ede8e2] rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-2xl font-light text-[#054700] mb-4">Ready to Partner?</h2>
            <p className="text-[#5a6623] mb-8 max-w-xl mx-auto">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-2 bg-[#054700] hover:bg-[#043d00] text-white px-8 py-3 rounded-full font-medium transition-colors"
            >
