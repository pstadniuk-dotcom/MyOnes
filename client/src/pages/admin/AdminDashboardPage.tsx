  ...
  return (
    <div className="p-8" data-testid="page-admin-dashboard">
      <div className="space-y-8">
        ...
        {/* Ingredient Pricing Settings */}
        <IngredientPricingCard onChanged={() => {
...
function IngredientPricingCard({ onChanged }: { onChanged?: () => void }) {
  const { toast } = useToast();
  ...
  return (
    <Card data-testid="card-ingredient-pricing">
      <CardHeader>
        ...
        <CardDescription>
          Internal reference values used for equivalent stack estimates in checkout.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading ? (
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        <Input
                          ...
                          onChange={(e) => updateDraft(row.id, 'typicalRetailPriceCents', Number(e.target.value) || 0)}
                          className="w-28"
                        />
                        <p className="text-xs text-muted-foreground">{formatDollars(draft.typicalRetailPriceCents)}</p>
                      </div>
                    </TableCell>
                    <TableCell>
                      <Switch
